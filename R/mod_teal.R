...
mod_teal <- function(
  ...
  # To be able to work with different versions of teal check if the arguments used by the wrapper are included
  checkmate::assert_subset(c("server", "ui", "datanames", "server_args", "ui_args"), names(teal_module))
